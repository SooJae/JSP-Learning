		...
		$.ajax({
			...
			success: function(result) {
				if (result == 1) {
					...
					/* attr은 속성 */
					/* panel-success는 초록색으로 표시, panel-warning은 노란색으로 표시. */
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control"
							onkeyup="passwordCheckFunction();" type="password"
	...
	<div class="modal fade" id="messageModal" tabindex="-1" role="dialog"
		...
		<div class="vertical-alignment-helper">
			<div class="modal-dialog vertical-align-center">
				<div
					class="modal-content <%if (messageType.equals("오류메세지"))out.println("panel-warning");
				else
